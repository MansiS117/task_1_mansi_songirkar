...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'due_date','assigned_to', 'assigned_by','assigned_at', 'priority','status', 'complete')
    list_display_links = ('id', 'title','assigned_to','assigned_by', 'assigned_at')
